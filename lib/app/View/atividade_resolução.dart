/* Injeção de dependecia é uma função da arquitetura de software que tem por objetivo
facilitar a manutenção e a implementação de aplicações , tornando os módulos de certa 
forma mais independentes. */
